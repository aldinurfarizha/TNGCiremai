...
public class BookingAdapter extends RecyclerView.Adapter<BookingAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(ItemViewHolder holder, final int position) {
        ...
        holder.jumlah_peserta.setText(dataList.get(position).getJumlah_peserta());
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder{
        private TextView tanggal_berangkat, jumlah_peserta, nama_porter, total_biaya, status;
        private CardView card;
        public ItemViewHolder(View itemView) {
            super(itemView);
            card = (CardView)itemView.findViewById(R.id.card);
            tanggal_berangkat=(TextView) itemView.findViewById(R.id.tanggal_berangkat);
            jumlah_peserta =(TextView) itemView.findViewById(R.id.jumlah_peserta);
