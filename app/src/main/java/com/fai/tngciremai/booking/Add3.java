...
public class Add3 extends AppCompatActivity {
    Spinner jenis_identitas1,jenis_identitas2, jenis_identitas3;
    Spinner jenis_kelamin1, jenis_kelamin2, jenis_kelamin3;
    EditText nomor_identitas1, nomor_identitas2, nomor_identitas3;
    EditText nama_lengkap1, nama_lengkap2, nama_lengkap3;
    EditText nomor_telepon1, nomor_telepon2, nomor_telepon3;
    EditText alamat1, alamat2, alamat3;
    Button selesai;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog=new ProgressDialog(Add3.this);
