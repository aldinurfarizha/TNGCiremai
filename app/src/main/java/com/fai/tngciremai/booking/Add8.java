...
public class Add8 extends AppCompatActivity {
    Spinner jenis_identitas1,jenis_identitas2, jenis_identitas3, jenis_identitas4, jenis_identitas5, jenis_identitas6, jenis_identitas7, jenis_identitas8;
    Spinner jenis_kelamin1, jenis_kelamin2, jenis_kelamin3, jenis_kelamin4, jenis_kelamin5, jenis_kelamin6, jenis_kelamin7, jenis_kelamin8;
    EditText nomor_identitas1, nomor_identitas2, nomor_identitas3, nomor_identitas4, nomor_identitas5, nomor_identitas6, nomor_identitas7, nomor_identitas8;
    EditText nama_lengkap1, nama_lengkap2, nama_lengkap3, nama_lengkap4, nama_lengkap5, nama_lengkap6, nama_lengkap7, nama_lengkap8;
    EditText nomor_telepon1, nomor_telepon2, nomor_telepon3, nomor_telepon4, nomor_telepon5, nomor_telepon6, nomor_telepon7, nomor_telepon8;
    EditText alamat1, alamat2, alamat3, alamat4, alamat5, alamat6, alamat7, alamat8;
    Button selesai;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jenis_identitas6=(Spinner) findViewById(R.id.jenis_identitas6);
        jenis_kelamin6=(Spinner) findViewById(R.id.jenis_kelamin6);
        nomor_identitas6=(EditText) findViewById(R.id.nomor_identitas6);
        nama_lengkap6=(EditText) findViewById(R.id.nama_lengkap6);
        nomor_telepon6=(EditText) findViewById(R.id.nomor_telepon6);
        alamat6=(EditText) findViewById(R.id.alamat6);


        jenis_identitas7=(Spinner) findViewById(R.id.jenis_identitas7);
        jenis_kelamin7=(Spinner) findViewById(R.id.jenis_kelamin7);
        nomor_identitas7=(EditText) findViewById(R.id.nomor_identitas7);
        nama_lengkap7=(EditText) findViewById(R.id.nama_lengkap7);
        nomor_telepon7=(EditText) findViewById(R.id.nomor_telepon7);
        alamat7=(EditText) findViewById(R.id.alamat7);


        jenis_identitas8=(Spinner) findViewById(R.id.jenis_identitas8);
        jenis_kelamin8=(Spinner) findViewById(R.id.jenis_kelamin8);
        nomor_identitas8=(EditText) findViewById(R.id.nomor_identitas8);
        nama_lengkap8=(EditText) findViewById(R.id.nama_lengkap8);
        nomor_telepon8=(EditText) findViewById(R.id.nomor_telepon8);
        alamat8=(EditText) findViewById(R.id.alamat8);
        ...
        dialog=new ProgressDialog(Add8.this);
    ...
    public void addKeberangkatan(){
        ...
        if(jenis_identitas6.getSelectedItem().toString().equals("--Pilih--")){
            Toast.makeText(this, "Jenis Identitas 6 Belum di isi", Toast.LENGTH_SHORT).show();
            return;
        }
        if(jenis_identitas7.getSelectedItem().toString().equals("--Pilih--")){
            Toast.makeText(this, "Jenis Identitas 7 Belum di isi", Toast.LENGTH_SHORT).show();
            return;
        }
        if(jenis_identitas8.getSelectedItem().toString().equals("--Pilih--")){
            Toast.makeText(this, "Jenis Identitas 8 Belum di isi", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(TextUtils.isEmpty(nomor_identitas6.getText().toString())){
            nomor_identitas6.setError("Kolom ini wajib di isi");
            nomor_identitas6.requestFocus();
            return;
        }
        if(TextUtils.isEmpty(nomor_identitas7.getText().toString())){
            nomor_identitas7.setError("Kolom ini wajib di isi");
            nomor_identitas7.requestFocus();
            return;
        }
        if(TextUtils.isEmpty(nomor_identitas8.getText().toString())){
            nomor_identitas8.setError("Kolom ini wajib di isi");
            nomor_identitas8.requestFocus();
            return;
        }
        ...
        if(TextUtils.isEmpty(nama_lengkap6.getText().toString())){
            nama_lengkap6.setError("Kolom ini wajib di isi");
            nama_lengkap6.requestFocus();
            return;
        }
        if(TextUtils.isEmpty(nama_lengkap7.getText().toString())){
            nama_lengkap7.setError("Kolom ini wajib di isi");
            nama_lengkap7.requestFocus();
            return;
        }
        if(TextUtils.isEmpty(nama_lengkap8.getText().toString())){
            nama_lengkap8.setError("Kolom ini wajib di isi");
            nama_lengkap8.requestFocus();
            return;
        }
        ...
        if(jenis_kelamin6.getSelectedItem().toString().equals("--Pilih--")){
            Toast.makeText(this, "Jenis Kelamin 6 Belum di isi", Toast.LENGTH_SHORT).show();
            return;
        }
        if(jenis_kelamin7.getSelectedItem().toString().equals("--Pilih--")){
            Toast.makeText(this, "Jenis Kelamin 7 Belum di isi", Toast.LENGTH_SHORT).show();
            return;
        }
        if(jenis_kelamin8.getSelectedItem().toString().equals("--Pilih--")){
            Toast.makeText(this, "Jenis Kelamin 8 Belum di isi", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(TextUtils.isEmpty(nomor_telepon6.getText().toString())){
            nomor_telepon6.setError("Kolom ini wajib di isi");
            nomor_telepon6.requestFocus();
            return;
        }
        if(TextUtils.isEmpty(nomor_telepon7.getText().toString())){
            nomor_telepon7.setError("Kolom ini wajib di isi");
            nomor_telepon7.requestFocus();
            return;
        }
        if(TextUtils.isEmpty(nomor_telepon8.getText().toString())){
            nomor_telepon8.setError("Kolom ini wajib di isi");
            nomor_telepon8.requestFocus();
            return;
        }
        ...
        if(TextUtils.isEmpty(alamat6.getText().toString())){
            alamat6.setError("Kolom ini wajib di isi");
            alamat6.requestFocus();
            return;
        }
        if(TextUtils.isEmpty(alamat7.getText().toString())){
            alamat7.setError("Kolom ini wajib di isi");
            alamat7.requestFocus();
            return;
        }
        if(TextUtils.isEmpty(alamat8.getText().toString())){
            alamat8.setError("Kolom ini wajib di isi");
            alamat8.requestFocus();
            return;
        }
        dialog.show();
        AndroidNetworking.post(ServerUrl.ADD_KEBERANGKATAN)
                ...
                .addBodyParameter("jenis_identitas6", jenis_identitas6.getSelectedItem().toString())
                .addBodyParameter("jenis_kelamin6", jenis_kelamin6.getSelectedItem().toString())
                .addBodyParameter("no_identitas6", nomor_identitas6.getText().toString())
                .addBodyParameter("nama_lengkap6", nama_lengkap6.getText().toString())
                .addBodyParameter("no_identitas6", nomor_identitas6.getText().toString())
                .addBodyParameter("nomor_telp6", nomor_telepon6.getText().toString())
                .addBodyParameter("alamat6", alamat6.getText().toString())



                .addBodyParameter("jenis_identitas7", jenis_identitas7.getSelectedItem().toString())
                .addBodyParameter("jenis_kelamin7", jenis_kelamin7.getSelectedItem().toString())
                .addBodyParameter("no_identitas7", nomor_identitas7.getText().toString())
                .addBodyParameter("nama_lengkap7", nama_lengkap7.getText().toString())
                .addBodyParameter("no_identitas7", nomor_identitas7.getText().toString())
                .addBodyParameter("nomor_telp7", nomor_telepon7.getText().toString())
                .addBodyParameter("alamat7", alamat7.getText().toString())


                .addBodyParameter("jenis_identitas8", jenis_identitas8.getSelectedItem().toString())
                .addBodyParameter("jenis_kelamin8", jenis_kelamin8.getSelectedItem().toString())
                .addBodyParameter("no_identitas8", nomor_identitas8.getText().toString())
                .addBodyParameter("nama_lengkap8", nama_lengkap8.getText().toString())
                .addBodyParameter("no_identitas8", nomor_identitas8.getText().toString())
                .addBodyParameter("nomor_telp8", nomor_telepon8.getText().toString())
                .addBodyParameter("alamat8", alamat8.getText().toString())
