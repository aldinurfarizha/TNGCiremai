...
public class Add4 extends AppCompatActivity {
    Spinner jenis_identitas1,jenis_identitas2, jenis_identitas3, jenis_identitas4;
    Spinner jenis_kelamin1, jenis_kelamin2, jenis_kelamin3, jenis_kelamin4;
    EditText nomor_identitas1, nomor_identitas2, nomor_identitas3, nomor_identitas4;
    EditText nama_lengkap1, nama_lengkap2, nama_lengkap3, nama_lengkap4;
    EditText nomor_telepon1, nomor_telepon2, nomor_telepon3, nomor_telepon4;
    EditText alamat1, alamat2, alamat3, alamat4;
    Button selesai;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog=new ProgressDialog(Add4.this);
